...
namespace HeroGameplayTags
{
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Ability_Stamina, "Player.Ability.Stamina");
    UE_DEFINE_GAMEPLAY_TAG(Player_Ability_BlockedBy_NoStamina, "Player.Ability.BlockedBy_NoStamina");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Event_ActivateRolling, "Player.Event.ActivateRolling");
    ...
    UE_DEFINE_GAMEPLAY_TAG(Player_Status_Stamina_Empty, "Player.Status.Stamina.Empty");
