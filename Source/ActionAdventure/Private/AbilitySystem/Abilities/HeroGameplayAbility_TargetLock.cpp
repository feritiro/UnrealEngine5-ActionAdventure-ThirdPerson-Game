...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor ||
		UBaseFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, HeroGameplayTags::Shared_Status_Dead) ||
		UBaseFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HeroGameplayTags::Shared_Status_Dead)
		)
	{
	...
	SetTargetLockWidgetPosition(); 
		...
		!UBaseFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HeroGameplayTags::Player_Status_Rolling)
		&&
		!UBaseFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), HeroGameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == HeroGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	if (!DrawnTargetLockWidget)
	{
		...
		DrawnTargetLockWidget = CreateWidget<UWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
